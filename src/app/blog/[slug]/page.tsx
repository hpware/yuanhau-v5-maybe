...
function BlogPostLoading() {
  return (
    <div className="flex flex-col items-center justify-center self-center h-screen absolute inset-0">
      <div role="status" className="p-0 m-0 justify-center align-middle flex flex-col items-center">
    <svg aria-hidden="true" className="w-1/2 h-1/2 text-xl text-gray-200 animate-spin self-center align-middle justify-center dark:text-gray-600 fill-blue-600 p-0 m-0 text-center content-center" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<span className="-translate-y-5 text-gray-500 dark:text-gray-400">Loading blog post...</span>
    </div>
  );
}
